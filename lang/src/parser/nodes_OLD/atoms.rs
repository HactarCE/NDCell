...
impl_display!(
    TypeName,
    "type name such as Integer, Cell, Vector, Vector[3] (capitalization matters)",
);
impl SyntaxConstruct for TypeName {
...
impl_display!(Identifier, "identifier such as a variable or function name");
impl SyntaxConstruct for Identifier {
...
#[derive(Debug, Copy, Clone)]
pub struct AssignOp;
impl_display!(AssignOp, "assignment symbol such as '=' or '+='");
impl SyntaxConstruct for AssignOp {
...
impl SyntaxConstruct for StringLiteral {
...
impl_display!(IntLiteral, "integer literal, such as '42'");
impl SyntaxConstruct for IntLiteral {
    type Output = LangInt;
    fn might_match(&self, tf: Parser<'_>) -> bool {
